...
template<typename T>
bool geometry_equals(GEOSContextHandle_t context, const T& geom, std::string expected) {
...
TEST_CASE("Multiple traversals", "[traversal-areas]") {
    ...
    CHECK( geometry_equals(context, left_hand_rings(context, b, traversals),
  "MULTIPOLYGON (((2 0, 2 2, 0 2, 0 0, 2 0)), "
